// Forked from AvalonEdit for UnoEdit — GetColor(null) changed to GetColor() to match portable API.
// Original: ICSharpCode.AvalonEdit/Highlighting/HighlightingColor.cs
...
namespace ICSharpCode.AvalonEdit.Highlighting
{
	...
	public class HighlightingColor : ISerializable, IFreezable, ICloneable, IEquatable<HighlightingColor>
	{
		...
		/// <summary>Gets/Sets the name of the color.</summary>
		public string Name {
			get { return name; }
			set {
		...
		/// <summary>Gets/sets the font family. Null if the highlighting color does not change the font style.</summary>
		...
		/// <summary>Gets/sets the font size. Null if the highlighting color does not change the font style.</summary>
		public int? FontSize {
			get { return fontSize; }
			set {
				if (frozen) throw new InvalidOperationException();
		...
		/// <summary>Gets/sets the font weight. Null if the highlighting color does not change the font weight.</summary>
		...
		/// <summary>Gets/sets the font style. Null if the highlighting color does not change the font style.</summary>
		...
		/// <summary>Gets/sets the underline flag. Null if the underline status does not change the font style.</summary>
		...
		/// <summary>Gets/sets the strikethrough flag. Null if the strikethrough status does not change the font style.</summary>
		...
		/// <summary>Gets/sets the foreground color applied by the highlighting.</summary>
		...
		/// <summary>Gets/sets the background color applied by the highlighting.</summary>
		...
		/// <summary>Creates a new HighlightingColor instance.</summary>
		public HighlightingColor()
		{
		}

		/// <summary>Deserializes a HighlightingColor.</summary>
		...
		/// <summary>Gets CSS code for the color.</summary>
		...
		/// <summary>Prevent further changes to this highlighting color.</summary>
		public virtual void Freeze()
		{
			frozen = true;
		}

		/// <summary>Gets whether this HighlightingColor instance is frozen.</summary>
		...
		public void MergeWith(HighlightingColor color)
		{
			...
			if (color.fontWeight != null) this.fontWeight = color.fontWeight;
			if (color.fontStyle != null) this.fontStyle = color.fontStyle;
			if (color.foreground != null) this.foreground = color.foreground;
			if (color.background != null) this.background = color.background;
			if (color.underline != null) this.underline = color.underline;
			if (color.strikethrough != null) this.strikethrough = color.strikethrough;
			if (color.fontFamily != null) this.fontFamily = color.fontFamily;
			if (color.fontSize != null) this.fontSize = color.fontSize;
		}

		/// <inheritdoc/>
		public bool IsEmptyForMerge {
			get {
				return fontWeight == null && fontStyle == null && foreground == null && background == null
					&& underline == null && strikethrough == null && fontFamily == null && fontSize == null;
			}
		}
	}
}
