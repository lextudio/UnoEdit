// Forked from AvalonEdit for UnoEdit — only change: added 'null' as the required
// PropertyMetadata argument to DependencyProperty.RegisterAttached.  WPF makes
// that parameter optional; WinUI3/Uno does not.
// Original: ICSharpCode.AvalonEdit/Rendering/LayerPosition.cs
...
namespace ICSharpCode.AvalonEdit.Rendering
{
	...
	sealed class LayerPosition : IComparable<LayerPosition>
	{
		internal static readonly DependencyProperty LayerPositionProperty =
			DependencyProperty.RegisterAttached("LayerPosition", typeof(LayerPosition), typeof(LayerPosition), null);
