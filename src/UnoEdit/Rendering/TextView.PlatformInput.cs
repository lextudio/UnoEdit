...
public sealed partial class TextView
{
    ...
    private void CoreTextEditContext_CommandReceived(object sender, CoreTextCommandReceivedEventArgs args)
    {
        ...
        bool handled = command switch
        {
            ...
            "scrollPageUp:" => MovePageVertical(-1, extendSelection: false),
            "scrollPageDown:" => MovePageVertical(1, extendSelection: false),
            "pageUp:" => MovePageVertical(-1, extendSelection: false),
            "pageDown:" => MovePageVertical(1, extendSelection: false),
            "pageUpAndModifySelection:" => MovePageVertical(-1, extendSelection: true),
            "pageDownAndModifySelection:" => MovePageVertical(1, extendSelection: true),
            "selectAll:" => SelectAll(),
            "copy:" => CopySelection(),
            "cut:" => CutSelection(),
            "undo:" => Undo(),
